...
def DPRINT(fmt, *args):
    """ include the method name in the debug print statement """
...
#------------------------------------------------------------------------------
# Python3: super() without arguments = super(__class__, self)
...
class Gradient(QtWidgets.QWidget):
    ...
    def paintEvent(self, e):
        # get the widget area from the painter for the widget
    ...
    def _find_stop_handle_for_event(self, e, to_exclude=None):
        ...
        #LOGGER.info("w={} h={} m={}".format(width, height, midpoint))
        DPRINT("w={}, h={}, m={}".format(width, height, midpoint))
    ...
    def mousePressEvent(self, e):
        ...
        if e.button() == Qt.RightButton:
            ...
            if n is not None:
                ...
                print("DRAG POSN:", self._drag_position)
