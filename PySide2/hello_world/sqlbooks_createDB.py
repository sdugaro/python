#------------------------------------------------------------------------------
# Port From C++ header file
# https://code.qt.io/cgit/qt/qtbase.git/tree/examples/sql/books/initdb.h
#------------------------------------------------------------------------------
...
""" C++ equiv
void addBook(QSqlQuery &q, const QString &title, int year, const QVariant
             &authorId, const QVariant &genreId, int rating)
{
...
def init_db():
    ...
    # Inner function to simplify the execution of SQL Statements
    def check(func, *args):
        if not func(*args):
